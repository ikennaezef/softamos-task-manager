		...
		<section className="bg-bgLight dark:bg-bgDark py-6">
			<div className="max-w-7xl mx-auto px-2">
				...
				<div className="flex items-stretch md:items-center flex-wrap md:flex-nowrap gap-3 space-x-0 md:gap-0 md:space-x-6">
					<div className="border border-gray-400 bg-pink-100 dark:bg-pink-400/40 rounded-xl shadow-md w-40 md:w-80 p-4">
						<span className="inline-block rounded bg-pink-300 dark:bg-pink-500/80 shadow-md mb-4 p-2">
							<AiOutlineCalendar size="1rem" />
						</span>
						<h4 className="text-xl text-primaryLight dark:text-primaryDark font-bold mb-2">
							Total Tasks
						</h4>
					...
					<div className="border border-gray-400 bg-yellow-100 dark:bg-yellow-400/40 rounded-xl shadow-md w-40 md:w-80 p-4">
					...
					<div className="border border-gray-400 bg-green-100 dark:bg-green-400/40 rounded-xl shadow-md w-40 md:w-80 p-4">
